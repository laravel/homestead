...
function serve-apache() {
    ...
    then
        ...
        sudo bash /vagrant/scripts/site-types/apache.sh "$1" "$2" 80 443 "${3:-7.3}"
    else
...
function serve-laravel() {
    ...
    then
        ...
        sudo bash /vagrant/scripts/site-types/laravel.sh "$1" "$2" 80 443 "${3:-7.3}"
    else
        echo "Error: missing required parameters."
        echo "Usage: "
...
function serve-proxy() {
    ...
    then
        ...
        sudo bash /vagrant/scripts/site-types/proxy.sh "$1" "$2" 80 443 "${3:-7.3}"
    else
        echo "Error: missing required parameters."
        echo "Usage: "
...
function serve-silverstripe() {
    ...
    then
        ...
        sudo bash /vagrant/scripts/site-types/silverstripe.sh "$1" "$2" 80 443 "${3:-7.3}"
    else
        echo "Error: missing required parameters."
        echo "Usage: "
...
function serve-spa() {
    ...
    then
        ...
        sudo bash /vagrant/scripts/site-types/spa.sh "$1" "$2" 80 443 "${3:-7.3}"
    else
        echo "Error: missing required parameters."
        echo "Usage: "
...
function serve-statamic() {
    ...
    then
        ...
        sudo bash /vagrant/scripts/site-types/statamic.sh "$1" "$2" 80 443 "${3:-7.3}"
    else
        echo "Error: missing required parameters."
        echo "Usage: "
...
function serve-symfony2() {
    ...
    then
        ...
        sudo bash /vagrant/scripts/site-types/symfony2.sh "$1" "$2" 80 443 "${3:-7.3}"
    else
        echo "Error: missing required parameters."
        echo "Usage: "
...
function serve-symfony4() {
    ...
    then
        ...
        sudo bash /vagrant/scripts/site-types/symfony4.sh "$1" "$2" 80 443 "${3:-7.3}"
    else
        echo "Error: missing required parameters."
        echo "Usage: "
...
function serve-pimcore() {
    ...
    then
        ...
        sudo bash /vagrant/scripts/site-types/pimcore.sh "$1" "$2" 80 443 "${3:-7.3}"
    else
        echo "Error: missing required parameters."
        echo "Usage: "
