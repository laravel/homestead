...
php8.1-snmp php8.1-soap php8.1-sqlite3 php8.1-sybase php8.1-tidy php8.0-xdebug php8.1-xml php8.0-xmlrpc php8.1-xsl \
php8.1-zip php8.0-memcached php8.0-redis
