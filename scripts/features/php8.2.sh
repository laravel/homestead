...
sed -i "s/group = www-data/group = $WSL_USER_GROUP/" /etc/php/8.2/fpm/pool.d/www.conf
sed -i "s/listen\.owner.*/listen.owner = $WSL_USER_NAME/" /etc/php/8.2/fpm/pool.d/www.conf
sed -i "s/listen\.group.*/listen.group = $WSL_USER_GROUP/" /etc/php/8.2/fpm/pool.d/www.conf
