class Homestead
  def Homestead.configure(config, boxsettings)

    config.vm.box = "laravel/homestead"

    boxsettings.each do |settings, index|
      config.vm.define settings["host"] do |config|
        ...
        # Configure The Box
        config.vm.hostname = settings["host"]
        ...
        ["vmware_fusion", "vmware_workstation"].each do |vmware|
          config.vm.provider vmware do |v|
            v.vmx["displayName"] = settings["host"]
