...
class MakeCommandTest extends TestCase
{
    ...
    public function a_vagrantfile_is_created_if_it_does_not_exists()
    {
        ...
        $this->assertEquals(
            ...
            file_get_contents(__DIR__.'/../stubs/LocalizedVagrantfile')
        );
    }
    ...
    public function an_aliases_file_is_created_if_requested()
    {
        ...
        $this->assertEquals(
            file_get_contents(__DIR__.'/../stubs/aliases'),
    ...
    public function an_after_shell_script_is_created_if_requested()
    {
        ...
        $this->assertEquals(
            file_get_contents(__DIR__.'/../stubs/after.sh'),
